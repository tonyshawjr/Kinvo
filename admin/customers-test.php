...
// Comment out the security headers to test if CSP is blocking styles
...
<head>
    ...
    <script>
        console.log('Loading customers-test.php - CSP disabled for testing');
    </script>
</head>
<body class="bg-gray-50 min-h-screen">
    <!-- Test banner to confirm this is the test page -->
    <div class="bg-yellow-500 text-black p-2 text-center font-bold">
        TEST PAGE - CSP DISABLED - If styles work here, CSP is the issue
    </div>
