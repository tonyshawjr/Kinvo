    ...
    <main class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4">
                <a href="settings.php" class="p-2 text-gray-700 hover:text-gray-700 transition-colors">
                    ←
                </a>
                <div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6 mb-8 shadow-sm">
            <div class="flex items-start space-x-4">
                <div class="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    <span class="text-red-700 text-xl font-bold">!</span>
                </div>
                <div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div class="bg-red-50 px-6 py-4 border-b border-red-200">
                <h3 class="text-lg font-semibold text-red-900 flex items-center">
                    <span class="mr-3 text-red-700 text-xl">⚠</span>
            ...
            <div class="p-6">
                <div class="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
                    ...
                    <ul class="space-y-2 text-red-800">
                        <li class="flex items-start">
                            <span class="text-red-700 mt-0.5 mr-2">×</span>
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                    <div class="flex items-start">
                        <span class="text-yellow-800 mt-0.5 mr-3 text-lg">ℹ</span>
                        <div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    <div class="flex items-start">
                        <span class="text-blue-800 mt-0.5 mr-3 text-lg">💡</span>
                        <div>
            ...
            <form method="POST" class="p-6">
                ...
                <div class="text-center mb-6">
                    <div class="inline-flex items-center justify-center w-20 h-20 bg-red-100 rounded-full mb-4">
                        <span class="text-red-700 text-3xl">💣</span>
                    </div>
                    ...
                    <p class="mt-4 text-2xl font-mono font-bold text-red-700">DELETE EVERYTHING</p>
                </div>
